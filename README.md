...
Are you tired of maintaining a *hugely complex* and *verbose* file, full of tables and other weird markup?
...
You can order each setting within a group by prepending a number followed by a pipe e.g. `1|My magnificent theme setting`. Your settings will now be ordered inside their group according to your numbers. Don't worry the generator knows to remove the prepended number from the generated settings.

**You can even order your setting groups!**
